...
def get_response_from_raw_image(file_path):
    ...
    bucket_lambda = "bucketlambdafunc"
    ...
    file_name = Path(file_path).name
     ...
     ## GENERATE URL
    original_image_url = f"https://{bucket_lambda}.s3.eu-north-1.amazonaws.com/{file_name}"
    ...
    try: 
        ...
        put_image_to_s3(file_path_processed, file_name)
        processed_image_url = f"https://{bucket_processed_img}.s3.eu-north-1.amazonaws.com/{file_name}"
...
#file_path = "/home/aime/python-environments/exam_script_deploy/IMG_1665.jpg"
