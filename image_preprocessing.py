...
def preprocessing_raw_image(path_raw_img, processed_path):
    ...
    try:
        yolo_path = "/tmp/yolo_cropped.jpeg"
    ...
    cropped_img = img.crop((minc, minr, maxc, maxr))
...
#preprocessing_raw_image("/home/aime/python-environments/exam_script_deploy/image_folder/IMG_1661.jpeg","/home/aime/python-environments/exam_script_deploy/image_folder/croo_IMG_1661.jpeg")