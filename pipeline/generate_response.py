...
from vision.image_preprocessing import detect_vertical_band_simplified, preprocessing_raw_image, split_if_band
...
def get_response_from_raw_image(file_path, file_name):
    ...
    file_path_processed_cropped = (
        os.path.join(path_to_processed, f"left_{file_name}"),
        os.path.join(path_to_processed, f"right_{file_name}"),
    )
...
# file_path = "/home/aime/python-environments/exam_script_deploy/image_folder/20230910114308.jpeg"
# file_name = "20230910114308.jpeg"

# get_response_from_raw_image(file_path, file_name)
