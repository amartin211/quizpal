...
from vision.mathpix import ocr_mathpix
from prompts_template.prompt_engineering_refined import get_ocr_status, check_text_completness
...
def preprocessing_raw_image(path_raw_img, processed_path):
    ...
    try:
        ...
        detect_screen_using_custom_yolo(path_raw_img, yolo_path)
...
path_to_image = "/home/aime/python-environments/exam_script_deploy/raw_images (copy)/20230910093627(1).jpeg"
path_to_processed = (
    "/home/aime/python-environments/exam_script_deploy/PROCESS_FOLDER/double_detect_20230910093627(1).jpeg"
)
# cropped_img = preprocessing_raw_image_double_detect(
#    path_to_image,
#    path_to_processed,
# )
# put_image_to_s3(
#    image_path=path_to_processed,
#    device_id="00000000261981f9",
#    filename="image_test.jpg",
# )

# result_openai = openai_ocr("https://bucketforprocessedimg.s3.eu-north-1.amazonaws.com/00000000261981f9/image_test.jpg")
# print(result_openai)

# print(get_ocr_status(result_openai))
# print(check_text_completness(result_openai))
# /home/aime/python-environments/exam_script_deploy/
# export PYTHONPATH="${PYTHONPATH}:/home/aime/python-environments/exam_script_deploy/"
